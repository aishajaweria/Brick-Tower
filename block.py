...
width = 500
height = 600
pygame.display.set_caption('Bricks Tower')
...
def showScore():
    ...
    text = font.render("Score: " + str(score) + "      High Score: " + str(hiscore), True, white)
...
# The Main Game Loop
def gameLoop():
    global brickW, brickH, score, hiscore, colorIndex, speed
    loop = True
